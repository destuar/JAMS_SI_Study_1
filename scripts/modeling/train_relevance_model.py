...
# --- Configuration ---
DATA_PATH = "data/annotate/completed/combined_annotations.csv"
MODEL_SAVE_PATH = "models/relevance_setfit_model"
TEXT_COLUMN = "full_text"
LABEL_COLUMN = "relevance_label"
TEST_SIZE = 0.2
RANDOM_STATE = 42
BASE_MODEL_ID = "sentence-transformers/all-MiniLM-L6-v2" # Lightweight and effective
...
args = TrainingArguments(
    output_dir="models/tmp_setfit_training", # Temporary dir for trainer artifacts
    num_epochs=NUM_EPOCHS_BODY,
    batch_size=BATCH_SIZE,
    learning_rate=LEARNING_RATE,
    num_epochs_classification_head=NUM_EPOCHS_HEAD,
    evaluation_strategy="epoch", # Evaluate at the end of each body epoch
...
trainer = SetFitTrainer(
    ...
    metric="accuracy", # Use accuracy for evaluation during training
)
